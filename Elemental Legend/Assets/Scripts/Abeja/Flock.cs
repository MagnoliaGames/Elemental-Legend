...
public class Flock : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 spawmBounds;
    ...
    private void GenerateUnits()
    {
        ...
        for (int i = 0; i < flockSize; i++)
        {
            ...
            randomVector = new Vector3(randomVector.x * spawmBounds.x, randomVector.y * spawmBounds.y, randomVector.z * spawmBounds.z);
